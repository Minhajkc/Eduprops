...
import { resetPassword, sendPasswordResetOtp, verifyPasswordResetOtp } from '../../../Services/studentService';
                ...
                {step === 1 && (
                    <div>
                        ...
                        <button
                            ...
                            className={`w-full bg-custom-cyan text-white p-2 rounded-lg mt-5 hover:bg-cyan-500 flex items-center justify-center ${loading ? 'opacity-60' : ''}`}
                            disabled={loading}
                        >
                ...
                {step === 2 && (
                    <div>
                        ...
                        <button
                            ...
                            className={`w-full bg-custom-cyan mt-5 text-white p-2 rounded-lg hover:bg-cyan-500 flex items-center justify-center ${loading ? 'opacity-60' : ''}`}
                            disabled={loading}
                        >
                            {loading && <Spin className="mr-2" indicator={<div className="ant-spin-dot"><i></i><i></i><i></i><i></i></div>} />}
                ...
                {step === 3 && (
                    <div>
                        ...
                        <button
                            ...
                            className={`w-full bg-custom-cyan mt-2 text-white p-2 rounded-lg hover:bg-cyan-500 flex items-center justify-center ${loading ? 'opacity-60' : ''}`}
                            disabled={loading}
                        >
                            {loading && <Spin className="mr-2" indicator={<div className="ant-spin-dot"><i></i><i></i><i></i><i></i></div>} />}
